...
<body>
<h2><i>ADD CUSTOMER</i></h2>
<div class="form-outer" class="form-horizontal">
<div class="form">
 <form:form action="addCustomer" method="Post" modelAttribute="customer">
   ...
   <div class="form-group">
    ...
    <div class="sub"><input type="submit" value="ADD" style="color:blue;background-color:yellow"></div>
  </form:form>
